...
export interface UserRecordCreationAttributes extends Optional<UserRecordAttributes, 'id' | 'status' | 'is_recharge' | 'is_package' | 'package_validity' | 'plan_id' | 'total_minutes' | 'bonus_minutes' | 'used_minutes' | 'remaining_minutes' | 'valid_from' | 'valid_till' | 'duration_type' | 'payment_id' | 'payment_status' | 'is_trial_buy' | 'plan_purchased_count' | 'created_at' | 'updated_at'> {
}
